...
; M558 P4 C3 I1 X0 Y0 Z1 H5 F100 T5000 ; Set Z probe type -- Enable LIMIT SWITCH
M558 P9 B0 H5 F120 T6000 A5 ; Set Z probe type -- BL Touch -- Slow movement
; M558 P9 B0 H5 F240 T24000 A5 ; Set Z probe type -- BL Touch -- Fast movement
...
; G31 P999 X0 Y-43 Z2.585  ; Set Z probe (Metrol switch) trigger value, offset
; G31 P999 X-43 Y25 Z0.925 ; Set Z probe (limit switch) trigger value, offset
G31 P999 X0 Y-35 Z1.95 ; Set Z probe (BL Touch) trigger value, offset
